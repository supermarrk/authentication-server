...
import org.pajunmacode.authenticationserver.repository.oauth2.AuthorizationConsentRepository;
...
public class JpaOAuth2AuthorizationConsentService implements OAuth2AuthorizationConsentService {
    ...
    public JpaOAuth2AuthorizationConsentService(AuthorizationConsentRepository authorizationConsentRepository, RegisteredClientRepository registeredClientRepository) {
        log.info("JpaOAuth2AuthorizationConsentService instantiated...");
    ...
    public void save(OAuth2AuthorizationConsent authorizationConsent) {
        log.info("OAuth2AuthorizationConsent save {}", authorizationConsent);
    ...
    public void remove(OAuth2AuthorizationConsent authorizationConsent) {
        log.info("OAuth2AuthorizationConsent remove...");
        Assert.notNull(authorizationConsent, "authorizationConsent cannot be null");
    ...
    public OAuth2AuthorizationConsent findById(String registeredClientId, String principalName) {
        log.info("OAuth2AuthorizationConsent findById: {} {}", registeredClientId, principalName);
    ...
    private OAuth2AuthorizationConsent toObject(AuthorizationConsent authorizationConsent) {
        log.info("OAuth2AuthorizationConsent toObject");
    ...
    private AuthorizationConsent toEntity(OAuth2AuthorizationConsent authorizationConsent) {
        log.info("OAuth2AuthorizationConsent toEntity");
