package org.pajunmacode.authenticationserver.service.auth;
...
import org.pajunmacode.authenticationserver.repository.oauth2.AuthorizationRepository;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    public JpaOAuth2AuthorizationService(AuthorizationRepository authorizationRepository, RegisteredClientRepository registeredClientRepository) {
        log.info("JpaOAuth2AuthorizationService instantiated");
    ...
    public void save(OAuth2Authorization authorization) {
        log.info("OAuth2Authorization save start...");
    ...
    public void remove(OAuth2Authorization authorization) {
        log.info("OAuth2Authorization remove start...");
        Assert.notNull(authorization, "authorization cannot be null");
    ...
    public OAuth2Authorization findById(String id) {
        log.info("OAuth2Authorization findById: {}", id);
    ...
    public OAuth2Authorization findByToken(String token, OAuth2TokenType tokenType) {
        log.info("OAuth2Authorization findByToken: {}", gson.toJson(tokenType));
        Assert.hasText(token, "token cannot be empty");

        Optional<Authorization> result;
        Authorization result2;
        if (tokenType == null) {
            log.info("NO IMPLEMENTATION FOR THIS BLOCK");
...
//            result = this.authorizationRepository.findByStateOrAuthorizationCodeValueOrAccessTokenValueOrRefreshTokenValue(token);
            ...
            result2 = this.authorizationRepository.findByAuthorizationCodeValue(token);
//            Object object =  this.authorizationRepository.findByAuthorizationCodeValue(token);
//            result2 = (Authorization) object;
            log.info("END findByToken");
            return toObject(result2);
    ...
    private OAuth2Authorization toObject(Authorization entity) {
        log.info("OAuth2Authorization toObject starts");
...
//            builder.token(idToken, metadata -> metadata.putAll(entity.getOidcIdTokenMetadata()));
    ...
    private Authorization toEntity(OAuth2Authorization authorization) {
        log.info("Authorization toEntity starts");
